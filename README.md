...
> ⚠️ DISCLAIMER ⚠️ : This was completely "vibe-coded" as we say, with some IA included. I'm still learning, and since both site didn't have an API with what i wanted, i had to generate some code mostly for the parsing and fetching data. Use at your own risks :p
